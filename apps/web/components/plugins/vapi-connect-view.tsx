...
import { VapiAssistantsTab } from '@/components/plugins/vapi-assistants-tab'
import { VapiPhoneNumbersTab } from '@/components/plugins/vapi-phone-numbers-tab'

interface VapiConnectViewProps {
	onDisconnect: () => void
}

export const VapiConnectView = ({ onDisconnect }: VapiConnectViewProps) => {
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<CardDescription>
									Manage your phones and AI assistants
								</CardDescription>
							</div>
						</div>
